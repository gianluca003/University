...
function getInformations(){
    ...
    const stories_id = param.get('story');
    ...
    if(!authAccess()){
        ...
        fetch(`http://localhost:3000/stories/${stories_id}`)
        ...
        .then(data =>{
            ...
            if(data.error){
                ...
                document.getElementById('type').innerText=data.informations.type;
                document.getElementById('originalIssue').innerText=data.informations.originalIssue.name;
